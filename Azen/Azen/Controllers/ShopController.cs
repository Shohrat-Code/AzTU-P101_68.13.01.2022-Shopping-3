...
namespace Azen.Controllers
{
    public class ShopController : Controller
    {
        ...
        public IActionResult Index(string searchData, int? prdId, int page = 1, double itemCount = 3)
        {
            ...
            List<Product> products = _context.Products
                                                      ...
                                                      .Where(p => (searchData != null ? p.Name.Contains(searchData) : true) &&
                                                                  (prdId != null ? p.CategoryId == prdId : true))
                                                      .ToList();
